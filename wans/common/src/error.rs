...
impl<E> From<E> for WanError where E: Error + 'static {
    fn from(value: E) -> Self {
        Self { kind: WanErrorKind::Other(Box::new(value)), context: None }
    }
}
...
impl WanError {
    ...
    pub fn other<E: Error + 'static>(error: E) -> Self {
        Self { kind: WanErrorKind::Other(Box::new(error)), context: None }
    }
    ...
    pub fn with_message<S: Into<String>>(msg: S) -> Self {
        Self { kind: WanErrorKind::Other(msg.into().into()), context: None }
    }
}